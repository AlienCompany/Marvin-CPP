    ...
    switch (commande.id) {
        case COMMANDE_LEG:
            ...
            switch (commande_16.data0){
                case MOTOR_HIP: rightLeg->setDegHip(commande_16.data1);
                case MOTOR_KNEE: rightLeg->setDegKnee(commande_16.data1);
                case MOTOR_ANKLE: rightLeg->setDegAnkle(commande_16.data1);
                case MOTOR_FOOT: rightLeg->setDegFoot(commande_16.data1);
            }
        default:
            break;
    }
